    ...
    return (
        <div className='w-full bg-yellow-400 min-h-screen flex flex-col lg:p-14 p-8  '>
            <div className='mx-auto w-full '>
                ...
                <div className="w-fit mx-auto"><button disabled={props.product_sold>=props.product_total} onClick={props.onclick} className='px-4 py-2 cursor-pointer bg-white mt-4 text-center ring-1 hover:ring-2 ring-black w-fit mx-auto font-bold focus:outline-none'>{props.product_sold>=props.product_total?'Out of stock':`NGN ${props.product_price}`}</button></div>
