                ...
                <main className=' flex  flex-col   w-full p-4'>
                    <section className=' max-h-screen flex '>
                        {success ?
                            ...
                            :
                            <> <div className='md:w-1/4 mx-auto my-auto block md:block w-full p-4 bg-white max-h-screen h-screen  static  overflow-y-auto border shadow-sm'>
                                <div className='w-full flex'><div className=' text-3xl md:text-2xl'>Place <span className='font-bold'>Order</span></div><div className=' text-lg md:text-xl'>Place <span className='font-bold'>{quantity * price}</span></div></div>
